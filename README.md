...
Version [21.4.0](https://github.com/microsoftconnect/ms-intune-app-sdk-ios/releases)

NOTE: We only support Intune App SDK version 20.0.0+ We recommend always staying up to date with the latest version.
